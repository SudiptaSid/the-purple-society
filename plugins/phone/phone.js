...
!(function (d) {
  ...
  var A = function (d, N) {
    (this.element = d),
      (this.preferred_country =
        "undefined" != typeof N ? N.preferred_country : ["fr", "us"]),
      (this.display_error = "undefined" != typeof N ? N.display_error : "on"),
      (this.error_message =
        "undefined" != typeof N ? N.error_message : A.DEFAULTS.error_message);
  };
  (A.VERSION = "0.0.1"),
    (A.DEFAULTS = {
      countries: [
      ...
      intlInputPhone:
        '<input type="hidden" name="intlInputPhone" class="intlInputPhone" size="2" value=\'@data\' />',
      separator: '<li role="separator" class="divider"></li>',
      template:
        '<div class="input-group"><div class="input-group-btn"><button type="button" id="btn-country" class="btn f16 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag @cca2 btn-flag"></span><span class="btn-cc">&nbsp;&nbsp; +@callingCode &nbsp;&nbsp;</span><span class="caret"></span></button> <ul class="dropdown-menu f16">@country_items</ul></div><input type="text" name="phoneNumber" id="phoneNumber" class="form-control phoneNumber" placeholder="+1 (555) 000-0000" size="25" /><input type="hidden" name="defaultCountry" id="defaultCountry" size="2" value="@cca2" /><input type="hidden" name="carrierCode" id="carrierCode" size="2" value="@callingCode" /></div>',
    }),
    ...
    (A.prototype.getDefaultCountry = function () {
      var N,
        $ = this;
      if (
        (d.each(A.DEFAULTS.countries, function (d, A) {
    ...
    (A.prototype.countryItems = function () {
      var N = "",
        ...
        t = "";
      return (
        d.each(A.DEFAULTS.countries, function (N, n) {
        ...
        e.length > 0 && ((N += e), (N += A.DEFAULTS.separator)),
        (N += t)
      );
    }),
    ...
    (A.prototype.validate = function (N) {
      ...
      return "object" != typeof $
        ? (d(".intlInputPhone").remove(),
          this.showError(N, this.getErrorMessage($)),
          !1)
        : (this.hideError(N),
          (e = A.DEFAULTS.intlInputPhone.format(["data"], [JSON.stringify($)])),
          d(".intlInputPhone").length > 0
            ? (d(".intlInputPhone").remove(), d(".input-group").append(e))
            : d(".input-group").append(e),
          void 0);
    }),
    (A.prototype.showError = function (d, N) {
      if ("string" == typeof this.display_error && "on" == this.display_error)
        d.attr("data-container", "body"),
          d.attr("data-toggle", "popover"),
          d.attr("data-placement", "right"),
          d.attr("data-content", N),
          d.popover("show");
      else {
    ...
    (A.prototype.hideError = function (d) {
      "object" == typeof this.display_error && this.display_error.remove(),
        d.removeAttr("data-container"),
        d.removeAttr("data-toggle"),
        d.removeAttr("data-placement"),
        d.removeAttr("data-content"),
        d.popover("destroy");
    }),
    ...
    (A.prototype.render = function (d, N) {
      this.element.html(
        d.format(
          this.arrayToKeysValues(N).keys,
          this.arrayToKeysValues(N).values
        )
      );
    }),
    (A.prototype.arrayToKeysValues = function (N) {
      if ("undefined" == typeof N)
        throw new Error("Can'convert undefined object");
      return {
        keys: Object.keys(N),
    ...
    (String.prototype.format = function (d, N) {
      for (var A, $ = this, e = 0; e < d.length; e++)
        (A = new RegExp("@" + d[e], "g")), ($ = $.replace(A, N[e]));
      return $;
    }),
        ...
        d(t).each(function () {
          ...
          e.hasClass("open") &&
            ((A &&
              ...
              d.contains(e[0], A.target)) ||
              (e.trigger((A = d.Event("hide.bs.dropdown", t))),
              A.isDefaultPrevented() ||
                ($.attr("aria-expanded", "false"),
                e
                  .removeClass("open")
                  .trigger(d.Event("hidden.bs.dropdown", t)))));
        }));
    }
    function $(N) {
      return this.each(function () {
        var A = d(this),
          $ = A.data("bs.dropdown");
        $ || A.data("bs.dropdown", ($ = new n(this))),
          "string" == typeof N && $[N].call(A);
      });
    }
      ...
      (n.prototype.toggle = function ($) {
        ...
        if (!e.is(".disabled, :disabled")) {
          ...
          if ((A(), !n)) {
            ...
            if (
              (t.trigger(($ = d.Event("show.bs.dropdown", a))),
              $.isDefaultPrevented())
            )
              return;
            e.trigger("focus").attr("aria-expanded", "true"),
              t.toggleClass("open").trigger(d.Event("shown.bs.dropdown", a));
          }
          return !1;
        }
      }),
        ...
        if (
          ...
          if (
            ...
            if ((!n && 27 != A.which) || (n && 27 == A.which))
              return (
                27 == A.which && e.find(t).trigger("focus"), $.trigger("click")
              );
  ...
  +(function (d) {
    ...
    function N(N) {
      return this.each(function () {
        ...
        (e || !/destroy|hide/.test(N)) &&
          (e || $.data("bs.tooltip", (e = new A(this, t))),
          "string" == typeof N && e[N]());
      });
    }
    var A = function (d, N) {
    ...
    (A.VERSION = "3.3.6"),
      ...
      (A.prototype.init = function (N, A, $) {
        if (
          ...
          (this.$viewport =
            ...
            d(
              d.isFunction(this.options.viewport)
        ...
        for (var e = this.options.trigger.split(" "), t = e.length; t--; ) {
          ...
          if ("click" == n)
            ...
            this.$element.on(
              a + "." + this.type,
              this.options.selector,
              d.proxy(this.enter, this)
            ),
              this.$element.on(
                i + "." + this.type,
                this.options.selector,
                d.proxy(this.leave, this)
              );
          }
        }
        this.options.selector
      ...
      (A.prototype.getOptions = function (N) {
        return (
          (N = d.extend({}, this.getDefaults(), this.$element.data(), N)),
          N.delay &&
      ...
      (A.prototype.getDelegateOptions = function () {
        ...
        return (
          this._options &&
            d.each(this._options, function (d, $) {
              A[d] != $ && (N[d] = $);
            }),
          N
        );
      ...
      (A.prototype.enter = function (N) {
        var A =
          N instanceof this.constructor
            ? N
            : d(N.currentTarget).data("bs." + this.type);
        return (
          A ||
            ...
            d(N.currentTarget).data("bs." + this.type, A)),
          N instanceof d.Event &&
            (A.inState["focusin" == N.type ? "focus" : "hover"] = !0),
      ...
      (A.prototype.leave = function (N) {
        ...
        return (
          A ||
            ...
            d(N.currentTarget).data("bs." + this.type, A)),
          N instanceof d.Event &&
            (A.inState["focusout" == N.type ? "focus" : "hover"] = !1),
          A.isInStateTrue()
            ? void 0
            : (clearTimeout(A.timeout),
              (A.hoverState = "out"),
      ...
      (A.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (o) {
            ...
            (a =
              "bottom" == a && r.bottom + l > u.bottom
                ? "top"
                : "top" == a && r.top - l < u.top
                ? "bottom"
                : "right" == a && r.right + c > u.width
                ? "left"
                : "left" == a && r.left - c < u.left
                ? "right"
                : a),
              t.removeClass(s).addClass(a);
          }
          ...
          d.support.transition && this.$tip.hasClass("fade")
            ? t
        ...
        isNaN(n) && (n = 0),
          ...
          d.offset.setOffset(
            ...
            d.extend(
              {
                using: function (d) {
                  $.css({ top: Math.round(d.top), left: Math.round(d.left) });
                },
              },
              N
            ),
      ...
      (A.prototype.replaceArrow = function (d, N, A) {
        this.arrow()
          .css(A ? "left" : "top", 50 * (1 - d / N) + "%")
          .css(A ? "top" : "left", "");
      }),
      (A.prototype.setContent = function () {
        var d = this.tip(),
          N = this.getTitle();
        d.find(".tooltip-inner")[this.options.html ? "html" : "text"](N),
          d.removeClass("fade in top bottom left right");
      }),
      (A.prototype.hide = function (N) {
        function $() {
          "in" != e.hoverState && t.detach(),
            e.$element
        ...
        return (
          ...
          n.isDefaultPrevented()
            ? void 0
            : (t.removeClass("in"),
              d.support.transition && t.hasClass("fade")
                ? t
                    .one("bsTransitionEnd", $)
                    .emulateTransitionEnd(A.TRANSITION_DURATION)
                : $(),
      ...
      (A.prototype.fixTitle = function () {
        var d = this.$element;
        (d.attr("title") || "string" != typeof d.attr("data-original-title")) &&
          d
            .attr("data-original-title", d.attr("title") || "")
            .attr("title", "");
      }),
      ...
      (A.prototype.getCalculatedOffset = function (d, N, A, $) {
        return "bottom" == d
          ? { top: N.top + N.height, left: N.left + N.width / 2 - A / 2 }
          : "top" == d
          ? { top: N.top - $, left: N.left + N.width / 2 - A / 2 }
          : "left" == d
          ? { top: N.top + N.height / 2 - $ / 2, left: N.left - A }
          : { top: N.top + N.height / 2 - $ / 2, left: N.left + N.width };
      }),
      (A.prototype.getViewportAdjustedDelta = function (d, N, A, $) {
        ...
        if (/right|left/.test(d)) {
          ...
          a < n.top
            ? (e.top = n.top - a)
            : i > n.top + n.height && (e.top = n.top + n.height - i);
        } else {
          var o = N.left - t,
            r = N.left + t + A;
          o < n.left
            ? (e.left = n.left - o)
            : r > n.right && (e.left = n.left + n.width - r);
        }
        return e;
      }),
      (A.prototype.getTitle = function () {
        ...
        return (d =
          ...
          ("function" == typeof A.title ? A.title.call(N[0]) : A.title));
      }),
      ...
      (A.prototype.tip = function () {
        if (
          !this.$tip &&
          ((this.$tip = d(this.options.template)), 1 != this.$tip.length)
        )
          throw new Error(
            this.type +
      ...
      (A.prototype.toggle = function (N) {
        var A = this;
        N &&
          ((A = d(N.currentTarget).data("bs." + this.type)),
          A ||
            ((A = new this.constructor(
              N.currentTarget,
              this.getDelegateOptions()
  ...
  +(function (d) {
    ...
    function N(N) {
      return this.each(function () {
        var $ = d(this),
          ...
          t = "object" == typeof N && N;
        (e || !/destroy|hide/.test(N)) &&
          (e || $.data("bs.popover", (e = new A(this, t))),
          "string" == typeof N && e[N]());
      });
    }
    var A = function (d, N) {
    ...
    (A.VERSION = "3.3.6"),
      (A.DEFAULTS = d.extend({}, d.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
        template:
      ...
      (A.prototype = d.extend({}, d.fn.tooltip.Constructor.prototype)),
      ...
      (A.prototype.setContent = function () {
        var d = this.tip(),
          N = this.getTitle(),
          A = this.getContent();
        d.find(".popover-title")[this.options.html ? "html" : "text"](N),
          d
      ...
      (A.prototype.getContent = function () {
        ...
        return (
          d.attr("data-content") ||
          ("function" == typeof N.content ? N.content.call(d[0]) : N.content)
        );
      }),
      (A.prototype.arrow = function () {
  ...
  !(function () {
    ...
    function N(d, N) {
      ...
      (A.prototype = N.prototype),
        ...
        (d.ma = function (d, A) {
          for (
            var $ = Array(arguments.length - 2), e = 2;
            e < arguments.length;
            e++
          )
            $[e - 2] = arguments[e];
    ...
    function r(d, N) {
      var A;
      d: {
        for (A in d) if (N.call(void 0, d[A], A, d)) break d;
        A = void 0;
      }
      return A && d[A];
    }
    ...
    function s(d) {
      if (!Bd[d]) {
        for (
          var N = 0,
            A = vd(String(Ld)).split("."),
            $ = vd(String(d)).split("."),
            t = Math.max(A.length, $.length),
            n = 0;
          0 == N && t > n;
          n++
        ) {
          ...
          do {
            ...
            N =
              e(
                0 == c[1].length ? 0 : parseInt(c[1], 10),
                0 == l[1].length ? 0 : parseInt(l[1], 10)
              ) ||
              e(0 == c[2].length, 0 == l[2].length) ||
              e(c[2], l[2]);
          } while (0 == N);
        }
        Bd[d] = N >= 0;
    ...
    function v(d, N) {
      for (var A = h(d.h()), $ = 0; $ < A.length; $++) {
        ...
        if (y(N, t)) {
          ...
          var n = 11 == e.b || 10 == e.b;
          if (e.f)
            for (var e = b(N, t) || [], a = 0; a < e.length; a++)
              w(d, t, n ? e[a].clone() : e[a]);
          else
            (e = b(N, t)),
              n ? ((n = b(d, t)) ? v(n, e) : E(d, t, e.clone())) : E(d, t, e);
        }
      }
    }
    function y(d, N) {
    ...
    function W(d, N) {
      for (var A, $ = new L(), e = d.length, t = 0; e > t; ++t)
        (A = d.charAt(t)), (A = N[A.toUpperCase()]), null != A && $.a(A);
      return $.toString();
    }
    function Y(d) {
    ...
    function Q(d, N, A) {
      ...
      if (!($ in Qd)) return e;
      if (1 == $) {
        if (null != A && 0 <= Sd(Qd[1], A.toUpperCase()))
          return $ + " " + J(d, N, 2);
      ...
      return (
        (A = ""),
        fd(NN, n) ? (A = n) : y(t, 17) && (A = T(t, 17)),
        (d = j(d, $, rd($))),
        (e = dd(e, d, 1)),
        (N = $d(N, d, 1)),
        0 < A.length ? A + " " + $ + " " + e + N : q($, 1, e, N)
      );
    }
    function z(d, N, A) {
      var $;
      ...
      switch (S(N, 6)) {
        ...
        default:
          ...
          var n;
          d: {
            if (((e = T(N, 5)), (e = W(e, Xd)), 0 == e.lastIndexOf(t, 0)))
              try {
                ...
                null == e
                  ...
                  : (($ = e.clone()),
                    ...
                    0 < e.length &&
                      ((t = T(d, 12)),
                      0 < t.length
                        ? ((e = e.replace(cN, t).replace(lN, "$1")), E($, 4, e))
                        : I($, 4)),
                    (e = Ad(A, $, 2))),
                (d = $d(N, d, 2)),
                (d = q(n, 2, e, d)))
    ...
    function Nd(d, N) {
      for (var A, $ = d.length, e = 0; $ > e; ++e) {
        ...
        var t = M(A, 3);
        if (
          (0 == t || 0 == N.search(S(A, 3, t - 1))) &&
          ((t = new RegExp(S(A, 1))), fd(t, N))
        )
          return A;
      }
      return null;
    ...
    function Ad(d, N, A, $) {
      var e = T(N, 2),
        ...
        a = "";
      return (
        2 == A && null != $ && 0 < $.length && 0 < n.length
          ? ((N = n.replace(sN, $)),
            (e = e.replace(rN, N)),
            (a = d.replace(t, e)))
          : ((N = T(N, 4)),
            (a =
              2 == A && null != N && 0 < N.length
                ? d.replace(t, e.replace(rN, N))
                : d.replace(t, e))),
        3 == A &&
          ((a = a.replace(
            RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"),
    ...
    function ud(d, N) {
      ...
      for (var $, e = A.length, t = 1; 3 >= t && e >= t; ++t)
        if ((($ = parseInt(A.substring(0, t), 10)), $ in Qd))
          return N.a(A.substring(t)), $;
      return 0;
    }
    function pd(d, N, A, $, e) {
      ...
      if (0 == n.length) t = 20;
        ...
        if (((n = new RegExp(t)), Z(d), (t = d.toString()), 0 == t.search(n))) {
          ...
          a && null != a[1] && 0 < a[1].length && "0" == W(a[1], Xd)
            ? (t = !1)
            : (B(d), d.a(t.substring(n)), (t = !0));
        } else t = !1;
        t = t ? 5 : 20;
      }
      if (($ && E(e, 6, t), 20 != t)) {
      ...
      if (
        ...
        if (
          ...
          (N = i.toString()),
          (a = T(a, 3)),
          (!fd(n, d.toString()) && fd(n, N)) || 3 == ld(a, d.toString()))
        )
          return A.a(N), $ && E(e, 6, 10), E(e, 1, t), t;
      }
      return E(e, 1, 0), 0;
    }
    function gd(d, N, A) {
      ...
      if (
        ...
        var i = e.length - 1;
        (N = S(N, 16)),
          null == N || 0 == N.length || null == e[i] || 0 == e[i].length
            ? (!n || fd(a, $.substring(e[0].length))) &&
              (null != A && i > 0 && null != e[i] && A.a(e[1]),
              (d.b = "" + $.substring(e[0].length)))
            : (($ = $.replace(t, N)),
              (!n || fd(a, $)) &&
                (null != A && i > 0 && A.a(e[1]), (d.b = "" + $)));
      }
    }
    function hd(d, N, A, $) {
      if (null == N)
      ...
      if (
        ((t = e.toString()),
        (n = t.indexOf(";isub=")),
        n > 0 && (B(e), e.a(t.substring(0, n))),
        !k(e.toString()))
      )
        throw "The string supplied did not seem to be a phone number";
      if (
        ((t = e.toString()),
        !(Y(A) || (null != t && 0 < t.length && AN.test(t))))
      )
        throw "Invalid country calling code";
      (t = new D()), $ && E(t, 5, N);
      d: {
      ...
      if (
        (0 != a
          ? ((e = rd(a)), e != A && (n = j(d, a, e)))
          : (Z(e),
            N.a(e.toString()),
            null != A ? ((a = T(n, 10)), E(t, 1, a)) : $ && I(t, 6)),
        2 > N.b.length)
      )
    ...
    var yd,
      ...
      Sd = bd.indexOf
        ...
        : function (N, A, $) {
            if (
              (($ = null == $ ? 0 : 0 > $ ? Math.max(0, N.length + $) : $),
              d(N))
            )
              return d(A) && 1 == A.length ? N.indexOf(A, $) : -1;
            for (; $ < N.length; $++) if ($ in N && N[$] === A) return $;
            return -1;
          };
    d: {
      var Td = Cd.navigator;
    ...
    var Ed,
      wd = -1 != yd.indexOf("Opera") || -1 != yd.indexOf("OPR"),
      Id = -1 != yd.indexOf("Trident") || -1 != yd.indexOf("MSIE"),
      Gd = -1 != yd.indexOf("Edge"),
      Od = !(
        -1 == yd.indexOf("Gecko") ||
        (-1 != yd.toLowerCase().indexOf("webkit") &&
          -1 == yd.indexOf("Edge")) ||
        -1 != yd.indexOf("Trident") ||
        -1 != yd.indexOf("MSIE") ||
        -1 != yd.indexOf("Edge")
      ),
      ...
      Ld = (function () {
        ...
        return (
          (d = ""),
          (N = c()) && (d = N ? N[1] : ""),
          Id && ((N = l()), N > parseFloat(d)) ? String(N) : d
        );
      })(),
      Bd = {},
      Pd = Cd.document,
      _d =
        Pd && Id
          ? l() || ("CSS1Compat" == Pd.compatMode ? parseInt(Ld, 10) : 5)
          : void 0;
    if (!(Ed = !Od && !Id)) {
      var xd;
      (xd = Id) && (xd = _d >= 9), (Ed = xd);
    ...
    (m.prototype.clone = function () {
      ...
      (O.prototype.a = function (N, A) {
        if (11 == N.b || 10 == N.b)
          return A instanceof m ? A : this.f(N.j.prototype.h(), A);
      ...
      (R.prototype.g = function (d) {
        for (var N = h(d.h()), A = {}, $ = 0; $ < N.length; $++) {
          ...
          if (y(d, e.a))
            if (e.f) {
              var n = [];
              for (A[t] = n, t = 0; t < M(d, e.a); t++)
                n.push(this.b(e, S(d, e.a, t)));
      ...
      (R.prototype.a = function (d, N) {
        return 8 == d.b && "number" == typeof N
          ? Boolean(N)
          : R.ha.a.call(this, d, N);
      }),
      (R.prototype.i = function (d, N) {
        ...
        for (A in N) {
          ...
          if ((e = a ? $.a[parseInt(A, 10)] || null : f($, A)))
            ...
            a
              ? ((e = d), (a = Number(A)), (e.b[a] = t), e.a && delete e.a[a])
              : n("Failed to find field: " + e);
        }
      }),
      (L.prototype.b = ""),
      (L.prototype.a = function (d, N) {
        if (((this.b += d), null != N))
    ...
    N(x, m),
        ...
        return (
          Yd ||
            (Yd = G(x, {
              ...
              19: { name: "number_format", ba: !0, c: 11, type: P },
              20: { name: "intl_number_format", ba: !0, c: 11, type: P },
              22: {
      ...
      (x.ctor = x),
      (x.ctor.h = x.prototype.h);
    var Jd;
    N(D, m);
    var jd = { la: 1, ka: 5, ja: 10, ia: 20 };
    (D.prototype.h = function () {
      ...
      (D.ctor = D),
      (D.ctor.h = D.prototype.h),
      N(K, O),
      (K.prototype.f = function (d, N) {
        var A = new d.b();
      ...
      (U.prototype.g = function (d) {
        for (var N = h(d.h()), A = [], $ = 0; $ < N.length; $++) {
          ...
          if (y(d, e.a)) {
            ...
            if (e.f) {
              A[t] = [];
              for (var n = 0; n < M(d, e.a); n++)
                A[t][n] = this.b(e, S(d, e.a, n));
            } else A[t] = this.b(e, S(d, e.a, void 0));
          }
        }
        return (
    ...
    for (var hN; pN.length && (hN = pN.shift()); ) {
      var fN;
      (fN = !pN.length) && (fN = void 0 !== md),
        fN ? (gN[hN] = md) : (gN = gN[hN] ? gN[hN] : (gN[hN] = {}));
    }
  })();
